        ...
        <div className="relative mx-auto max-w-3xl">
          ...
          <div className="mt-12 space-y-10 text-white/75 leading-relaxed">
            <Section title="1. Who we are">
              Viddix AI ("Viddix", "we", "us") provides AI agency services including custom AI
              agents, SaaS platform development, automations, and growth strategy. This policy
              explains what personal data we collect through this website (viddix.ai and its
              subdomains), how we use it, and your rights regarding it.
            </Section>
            ...
            <Section title="4. Cookies and analytics">
              We use a small set of cookies and analytics tools to understand how visitors use the
              site. You can accept or decline non-essential cookies via the consent banner shown on
              your first visit. Strictly necessary cookies (for example, those that remember your
              consent choice) are always set.
            </Section>

            <Section title="5. Sharing">
              We share data only with vetted service providers we use to operate (for example, our
              email provider, analytics provider, and hosting platform). These providers are bound by
              their own data processing agreements. We do not share your data with marketing networks
              or sell it to third parties.
            </Section>

            <Section title="6. Retention">
              We keep contact data for as long as needed to respond to your inquiry and maintain the
              relationship. If we don't move forward together, we'll retain your data for a
              reasonable period (typically up to 24 months) and then remove it on request.
            </Section>
            ...
            <Section title="7. Your rights">
              ...
              <p>
                ...
                <a href="mailto:viddixai@gmail.com" className="text-[#22D3EE] hover:underline">
                  viddixai@gmail.com
                </a>
                .
              </p>
            ...
            <Section title="8. Security">
              ...
              method of transmission or storage is 100% secure, so we encourage you to share only
              the information we need to respond to your request.
            </Section>

            <Section title="9. Changes to this policy">
              We may update this policy as our practices evolve. We'll update the "Last updated"
              date at the top of the page when we do.
            </Section>

            <Section title="10. Contact">
              For any questions about privacy, reach us at{" "}
              <a href="mailto:viddixai@gmail.com" className="text-[#22D3EE] hover:underline">
                viddixai@gmail.com
              </a>
              .
