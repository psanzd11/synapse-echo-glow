    ...
    return (
      <main className="min-h-screen bg-black text-white">
        ...
        <section className="pt-40 pb-32 px-6 text-center">
          <h1 className="text-3xl sm:text-4xl font-medium mb-4">Case study not found</h1>
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="relative pt-40 pb-16 px-6 overflow-hidden">
        <div className={`pointer-events-none absolute -top-40 left-1/2 -translate-x-1/2 h-[500px] w-[800px] rounded-full bg-gradient-to-br ${study.accent} blur-[140px] opacity-70`} />
      ...
      <section className="relative px-6 pb-32 border-t border-white/5">
        <div className="relative mx-auto max-w-4xl pt-20 grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          >
            ...
            <h2 className="text-2xl font-medium text-white mb-4">The starting point</h2>
          ...
          >
            ...
            <h2 className="text-2xl font-medium text-white mb-4">What we built</h2>
          ...
          >
            ...
            <h2 className="text-2xl font-medium text-white mb-4">The result</h2>
            <ul className="space-y-3">
      ...
      <section className="relative px-6 py-20 border-t border-white/5">
        <div className="relative mx-auto max-w-6xl">
          <div className="flex items-center justify-between mb-10">
            <h3 className="text-xl sm:text-2xl font-medium text-white">More case studies</h3>
            <Link
              to="/case-studies"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {otherStudies.map((c) => (
              ...
              >
                <div className={`absolute -top-32 -right-20 h-64 w-64 rounded-full bg-gradient-to-br ${c.accent} blur-3xl opacity-40 group-hover:opacity-70 transition-opacity`} />
