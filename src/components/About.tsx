...
export const About = () => {
  ...
  return (
    <section id="about" className="relative bg-black text-white py-16 sm:py-24 md:py-32 px-5 sm:px-6 border-t border-white/5">
      ...
      <div className="relative mx-auto max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-medium tracking-tight bg-gradient-to-b from-white to-white/60 bg-clip-text text-transparent leading-[1.05]">
            {t.about.heading}
          </h2>
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="relative rounded-3xl border border-white/10 bg-gradient-to-b from-white/[0.05] to-white/[0.01] backdrop-blur-xl p-6 sm:p-8 overflow-hidden">
            ...
            <div className="relative mt-8 grid grid-cols-1 sm:grid-cols-2 gap-3 pt-6 border-t border-white/10 text-sm">
              <a
                href="mailto:viddixai@gmail.com"
