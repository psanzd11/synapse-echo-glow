...
const services = [
  {
    ...
    desc: "Plug-and-play automations that eliminate repetitive work — internal data capture, client follow-ups, cross-tool syncs.",
    tag: "Save 20+ hrs/week",
  },
  {
    Icon: Bot,
    title: "Custom AI Agents",
    desc: "Domain-trained voice, support, outbound, and research agents that qualify leads and execute tasks 24/7.",
    tag: "Always on",
  },
  {
    Icon: Layers,
    title: "Complete AI Systems",
    desc: "End-to-end AI infrastructure tailored to your operations — built, deployed, and maintained as a system.",
    tag: "Full-stack",
  },
  {
    Icon: Smartphone,
    title: "Apps & SaaS Platforms",
    desc: "Custom SaaS products and apps engineered with AI-native features from day one — PMS, CRM, marketplaces, dashboards.",
    tag: "SaaS · iOS · Android · Web",
  },
  {
    Icon: PenTool,
    title: "Web Design",
    desc: "High-conversion sites and brand systems designed to turn visitors into pipeline.",
    tag: "Conversion-led",
  },
  {
    Icon: Megaphone,
    title: "Marketing & Strategy",
    desc: "Growth strategy and performance marketing — paid, SEO, content, and category positioning trusted by sector leaders.",
    tag: "ROI-focused",
  },
];
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        >
          ...
          <h2 className="text-4xl sm:text-5xl font-medium tracking-tight bg-gradient-to-b from-white to-white/60 bg-clip-text text-transparent">
            One partner. The entire AI stack.
          </h2>
          <p className="mt-4 text-white/60 text-base sm:text-lg">
            From quick wins to full systems — we ship the AI infrastructure modern businesses run on.
          </p>
        </motion.div>
