      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            <Link to="/" className="inline-flex items-center gap-2 text-white font-medium tracking-tight text-lg">
            ...
            <p className="mt-4 text-sm text-white/55 leading-relaxed max-w-sm">
              We design, build, and deploy custom AI agents, SaaS platforms, and growth strategy for businesses that move fast.
            </p>
            <a
          ...
          <div>
            <h4 className="text-xs uppercase tracking-[0.2em] text-white/50 mb-4">Navigate</h4>
            <ul className="space-y-2.5">
              ...
              <li>
                <Link to="/book" className="text-sm text-white/70 hover:text-white transition-colors">
                  Book a Call
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h4 className="text-xs uppercase tracking-[0.2em] text-white/50 mb-4">Legal</h4>
            <ul className="space-y-2.5">
              {legal.map((l) => (
                <li key={l.label}>
                  <Link to={l.to} className="text-sm text-white/70 hover:text-white transition-colors">
        ...
        <div className="mt-14 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/40">
          <p>© {new Date().getFullYear()} Viddix AI — Engineered for businesses that move fast.</p>
